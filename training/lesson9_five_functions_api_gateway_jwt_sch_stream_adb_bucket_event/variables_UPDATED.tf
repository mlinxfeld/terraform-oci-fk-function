...
variable "compartment_ocid" {
  description = "OCI compartment OCID used for lesson8 resources."
  type        = string
}
...
variable "fn_debug_mode" {
  description = "Whether lesson8 functions should emit additional debug logs."
  type        = bool
  default     = true
}
...
variable "fn_jwt_token" {
  description = "Shared JWT-like token validated by the custom authorizer function."
  type        = string
  default     = "ABCD1234"
}

variable "bucket_name" {
  description = "Explicit Object Storage bucket name used by the bulk-load ingestion scenario."
  type        = string
  default     = "FoggyKitchenIOTBucket"
}
